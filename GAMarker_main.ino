...
float
elapsedtime, time, timeprev, currenttime;
...
void setup() {
  ...
  mpu.initialize();
// old offsets
//  mpu.setXGyroOffset(50); //this was at 220
//  mpu.setYGyroOffset(-41); //76
//  mpu.setZGyroOffset(-19); //-85
//  //these are ones I put
//  mpu.setXAccelOffset(-4275);
//  mpu.setYAccelOffset(-3406);
//  mpu.setZAccelOffset(1487);

// new offsets as of 2019.04.08
// taken when sensor was set on flat ground, warmed up, and precise calibration (or as precise as I could have made it)
  mpu.setXGyroOffset(50); //this was at 220
  mpu.setYGyroOffset(-39); //76
  mpu.setZGyroOffset(-18); //-85
  //these are ones I put
  mpu.setXAccelOffset(-4172);
  mpu.setYAccelOffset(-3436);
...
void loop() {
currenttime = millis();
//  while(millis() <= 4001){ // this is to test individual axes for data collecting/analysis; comment as you wish
  mpu.getMotion6(&rawaccx, &rawaccy, &rawaccz, &rawgyrx, &rawgyry, &rawgyrz);
  /*float vals =*/ getaccel(rawaccx, rawaccy, rawaccz);  // just to print this function
...
/*  Serial.print("X:  ");*/ Serial.print(realaccx); Serial.print(" \t"); // m/s2   |  ");
/*  Serial.print("Y:  ");*/ Serial.print(realaccy); Serial.print("      \t"); // m/s2   |   ");
/*  Serial.print("Z:  ");*/ Serial.print(realaccz); Serial.print("      \t"); // m/s2   |   ");
Serial.print((currenttime - 1000) / 1000); Serial.print("         \t");
//  Serial.print("oX:  "); Serial.print(realdegx); Serial.print("\t o/s   |   ");
//  Serial.print("oY:  "); Serial.print(realdegy); Serial.print("      \t o/s   |   ");
//  Serial.print("oZ:  "); Serial.print(realdegz); Serial.print("      \t o/s   |   ");
  Serial.println(" ");
//  Serial.println("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"); // use this when debugging

//  } // comment this if no while loop 
  timeprev = currenttime; // this is for finding the time difference
}
